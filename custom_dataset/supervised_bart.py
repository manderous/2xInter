...
class RAMSDataset_bart(Dataset):
    ...
    def __init__(self,
        ...
        #######################以下多行代替该代码段####################################
        # self.sen_max_len = 72  # tjy 句子的最大长度 ace:74, lowkbp:84, rams:72
        # self.prompt_max_len = 20  # tjy 提示模板的最大长度 ace:18, lowkbp:19, rams:20, prob:ace:19,lowkbp:21,rams:22
        ###########################################################

        if dataset == 'ace':
            self.sen_max_len = 74
            self.prompt_max_len = 18
        elif dataset == 'rams':
            self.sen_max_len = 72
            self.prompt_max_len = 20
        elif "lowkbp" in dataset:
            self.sen_max_len = 84
    ...
    def preprocess(self, i):
        ...
        for tem_id in range(3):  # 遍历3,4,5,6个模板
